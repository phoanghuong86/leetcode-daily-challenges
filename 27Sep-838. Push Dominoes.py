class Solution:         # States for the dominoes:
                        ...
                        #  Here's the plan:
                        #    1) We replace 'R.' --> 'RR', .L' --> 'LL' .  To avoid the problem with
                        #       the 'R.L' state, we replace each 'R.L' with a dummy string (say, 'xxx').
                        #       
                        #    2) We perform the 'R.' --> 'RR', .L' --> 'LL' replacements.

                        #    3) Once the actions described in 1)  and 2) are completed, we repeat until
                        #       no changes occur. we replace the dummy string with 'R.L'. 
